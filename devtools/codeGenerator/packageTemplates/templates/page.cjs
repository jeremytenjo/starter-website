...
import ${contentPageName}Content from '../../pagesContent/${contentPageName}/${contentPageName}'
import { ${propsProviderName} } from '../../pagesContent/${contentPageName}/use${contentPageName}Props/use${contentPageName}Props'
